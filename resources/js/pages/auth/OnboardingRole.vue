  ...
  <div class="ob-layout">
    ...
    <div class="ob-panel-right">
      <div class="ob-panel-right-inner">
        ...
        <button type="button" class="btn btn-outline ob-btn-full" @click="goBack">Change Role</button>
...
.or-role-card { display:flex; align-items:center; gap:16px; border:1px solid var(--border); border-left:2px solid var(--gold); border-radius:var(--radius); padding:18px 20px; background:var(--surface-2); margin-bottom:24px; }
