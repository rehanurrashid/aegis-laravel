      ...
      <div class="settings-content">
        ...
        <div v-show="section === 'stripe_connect'" class="settings-panel">
          <SettingsStripeConnect
            ...
            description="Connect your Stripe account to receive contract and milestone payments from practitioners. Funds go directly to your bank account — Aegis never holds your money."
          />
        </div>
