...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8" /><title>Referral Accepted — Aegis</title></head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        <tr><td style="background:#2c2218;padding:24px 32px;">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td align="right" style="font-size:11px;color:#c4a96a;font-weight:600;text-transform:uppercase;letter-spacing:1px;">Referral Accepted</td>
            </tr>
          </table>
        </td></tr>
        <tr><td style="background:#27ae60;padding:10px 32px;">
          <p style="margin:0;color:#ffffff;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.8px;">✓ Referral Accepted</p>
        </td></tr>
        <tr><td style="padding:32px;">
          <p style="margin:0 0 24px;font-family:'Spectral',Georgia,serif;font-size:24px;font-weight:700;color:#2c2218;line-height:1.3;">
            {{ $recipient?->display_name ?? 'Your colleague' }} accepted your referral
          </p>
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e8e0d4;border-radius:8px;overflow:hidden;margin-bottom:24px;">
            <tr style="background:#f9f5ee;">
              <td style="padding:10px 16px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.6px;color:#8a7c6e;border-bottom:1px solid #e8e0d4;">Accepted by</td>
            ...
            <tr>
              <td style="padding:10px 16px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.6px;color:#8a7c6e;">Responded</td>
          ...
          <p style="margin:0 0 20px;font-size:13px;color:#6b5f52;line-height:1.6;">
            Great news — your client referral has been accepted. The receiving provider will be in contact with the client to arrange next steps.
          </p>
