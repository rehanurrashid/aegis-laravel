...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8" /><title>Referral Cancelled — Aegis</title></head>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:32px;">
          <p style="margin:0 0 6px;font-size:14px;color:#8a7c6e;">A referral sent to you has been withdrawn.</p>
          <p style="margin:0 0 24px;font-family:'Spectral',Georgia,serif;font-size:24px;font-weight:700;color:#2c2218;line-height:1.3;">
            {{ $sender?->display_name ?? 'A colleague' }} cancelled a referral
          </p>
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e8e0d4;border-radius:8px;overflow:hidden;margin-bottom:24px;">
            ...
            <tr>
              <td style="padding:10px 16px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.6px;color:#8a7c6e;">Referral</td>
              <td style="padding:10px 16px;font-size:13px;color:#2c2218;">{{ $subject }}</td>
            </tr>
          </table>
          <p style="margin:0 0 20px;font-size:13px;color:#6b5f52;line-height:1.6;">
            No action is required on your part. This referral has been moved to archive. If you have any questions, you can contact {{ $sender?->display_name }} directly through Aegis Messages.
          </p>
        ...
        <tr><td style="background:#f9f5ee;border-top:1px solid #e8e0d4;padding:20px 32px;">
          <p style="margin:0;font-size:11px;color:#8a7c6e;">You're receiving this because a referral sent to you through Aegis has been cancelled.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
