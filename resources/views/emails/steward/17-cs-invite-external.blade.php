@include('emails._partials.head', ['email_title' => 'You have been invited to serve as a Continuity Steward'])
              ...
              <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;
                ...
                {{ $practitioner_name ?? 'A healthcare practitioner' }}
                ...
                <tr>
                  <td style="background-color:#f5f0e6;border:1px solid #d4c4a0;
                    ...
                    <p style="margin:8px 0 0;font-family:Arial,Helvetica,sans-serif;
                      ...
                      If the button above doesn't work, go to aegis.devlet.tech/register,
                      choose <strong>Continuity Steward → Invited</strong>, and enter this code manually.
                    </p>
                  </td>
                </tr>
              </table>
