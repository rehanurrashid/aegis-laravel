@include('emails._partials.head', ['email_title' => 'You have received a referral'])
              ...
              <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;
                ...
                <strong>{{ $referrer_name ?? 'A colleague' }}</strong>
                ...
                <tr>
                  <td style="background-color:#f5f0e6;border-left:3px solid #a0813e;
                    ...
                    <p style="margin:0 0 4px;font-family:Arial,Helvetica,sans-serif;
                      ...
                      Note from {{ $referrer_name ?? 'your colleague' }}
                    </p>
