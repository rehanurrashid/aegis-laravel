@include('emails._partials.head', ['email_title' => 'Your connection request was accepted'])
              ...
              <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;
                ...
                Dear {{ $requester_name ?? 'there' }},
                <strong>{{ $acceptor_name ?? 'Your contact' }}</strong>
                @if(!empty($acceptor_role))
                  ({{ $acceptor_role }})
                @endif
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td style="background-color:#a0813e;border-radius:8px;">
                    <a href="{{ $profile_url ?? rtrim(config('app.url'),'/') }}"
