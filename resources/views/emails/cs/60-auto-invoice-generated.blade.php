@include('emails._partials.head', ['email_title' => 'CS engagement invoice generated'])

              <h1 style="margin:0 0 16px;font-family:'Georgia','Times New Roman',serif;
                         font-size:22px;font-weight:700;color:#2d2a26;line-height:1.3;">
                Your Continuity Steward engagement invoice is ready
              </h1>

              <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;
                        font-size:14px;line-height:1.6;color:#4a4741;">
                Dear {{ $user_name ?? 'there' }},
                following the closure of your continuity incident, your Continuity Steward
                has issued an engagement invoice for their services.
              </p>
                ...
                <tr>
                  <td style="background-color:#f5f0e6;border-left:3px solid #a0813e;
                    ...
                    <p style="margin:0;font-family:Arial,Helvetica,sans-serif;
                      ...
                      @else
                        <strong>Status:</strong> Awaiting payment — please review and pay in your portal.
                      @endif
                    </p>
                  </td>
                </tr>
