@include('emails._partials.head', ['email_title' => 'Your Aegis plan will be downgraded'])
              ...
              <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;
                ...
                @if(!empty($downgrade_effective_date))
                  on <strong>{{ $downgrade_effective_date }}</strong>
                @endif.
              </p>
