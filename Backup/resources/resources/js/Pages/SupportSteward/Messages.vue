<template>
  <AppLayout :user="user" portal="support_steward" activePage="messages" pageTitle="Messages" :has-emergency="true">
...
const threads = [
  {
    ...
    preview: "You: Quick note — I'll be out Marc...", time: '3w', unread: false,
    messages: [
      { type: 'divider', label: 'Sat, Feb 14' },
      { type: 'msg', dir: 'out', text: 'Task list reviewed and certified. I have my copy of the emergency vault manifest printed and filed.', time: '4:48 PM', read: true },
      { type: 'msg', dir: 'in', text: 'Perfect. Thank you Linda. Let me know if anything changes on your end.', time: '5:12 PM' },
      { type: 'divider', label: 'Sun, Mar 15' },
      { type: 'msg', dir: 'out', text: "Quick note — I'll be out March 22–25. Already let Marcus know. James is covering if anything urgent comes up.", time: '9:30 AM', read: true },
    ],
  },
  {
    id: 'mc', initials: 'MC', name: 'Marcus Chen', role: 'Continuity Steward', tag: 'Continuity Contact',
    org: 'Chen Practice Solutions', email: 'marcus@chenpracticesolutions.com', phone: '(510) 555-0189', based: 'Oakland, CA',
    preview: 'You: Thanks Marcus. Noted. H...', time: 'Feb 16', unread: false,
    messages: [
      { type: 'divider', label: 'Sun, Apr 26' },
      { type: 'msg', dir: 'out', text: 'Hi Marcus — I reported the Short-Term Incapacitation for Dr. Sarah Johnson this morning. Documentation is in the incident record. Let me know what you need from me.', time: '8:40 AM', read: true },
      { type: 'msg', dir: 'in', text: "Thanks Linda. I've verified the incident and activated coverage. I may need help rescheduling this week's appointments.", time: '9:15 AM' },
      { type: 'msg', dir: 'out', text: "Thanks Marcus. Noted. Happy to help wherever I can.", time: '10:05 AM', read: true },
    ],
  },
];
...
const recipients = [
  { initials: 'MC', name: 'Marcus Chen', role: 'Continuity Steward' },
  { initials: 'PR', name: 'Dr. Priya Raman', role: 'Continuity Steward' },
  { initials: 'TC', name: 'Dr. Thomas Chen', role: 'Continuity Steward' },
  { initials: 'SJ', name: 'Dr. Sarah Johnson', role: 'Practitioner' },
  { initials: 'MT', name: 'Dr. Michael Torres', role: 'Practitioner' },
  { initials: 'RO', name: 'Dr. Rachel Okafor', role: 'Practitioner' },
];
