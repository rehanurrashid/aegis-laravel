<template>
  <AppLayout :user="user" portal="practitioner" activePage="referrals" pageTitle="Referrals">
    <div class="hero-banner is-quiet">
      <div class="page-hero-inner">
        <div class="page-hero-text">
          <div class="page-hero-eyebrow">Referrals</div>
          <h1 class="page-hero-title">Referral Coordination</h1>
        <p class="page-hero-sub">Manage incoming and outgoing referrals with your network.</p>
        </div>
        <div class="page-hero-actions"></div>
      </div>
    </div>
    <div class="stat-chip-row">
      <div class="stat-chip"><span class="stat-chip-label">Pending</span><span class="stat-chip-value">3</span> <span class="stat-chip-sub">Awaiting response</span></div>
      <div class="stat-chip"><span class="stat-chip-label">Active</span><span class="stat-chip-value">5</span> <span class="stat-chip-sub">In progress</span></div>
      <div class="stat-chip"><span class="stat-chip-label">Completed</span><span class="stat-chip-value">24</span> <span class="stat-chip-sub">This year</span></div>
      <div class="stat-chip"><span class="stat-chip-label">Response Rate</span><span class="stat-chip-value">92%</span></div>
    </div>
    <div class="tabs-segmented" style="margin-bottom:22px;">
      <button class="tab-pill active" :class="{ active: tab === 'pending' }" @click="tab = 'pending'">Pending <span class="tab-count">3</span></button>
      <button class="tab-pill" :class="{ active: tab === 'active' }" @click="tab = 'active'">Active <span class="tab-count">5</span></button>
      <button class="tab-pill" :class="{ active: tab === 'completed' }" @click="tab = 'completed'">Completed</button>
      <button class="tab-pill" :class="{ active: tab === 'archive' }" @click="tab = 'archive'">Archive</button>
    </div>
    <div class="pg-list">
      <div class="pg-item"><div class="pg-item-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg></div><div class="pg-item-content"><div class="pg-item-title">Referral to Dr. Michael Chen</div><div class="pg-item-sub">Anxiety disorder evaluation — Patient: John D.</div></div><span class="badge badge-warning">Pending</span><span class="pg-item-meta">2 days ago</span></div>
      <div class="pg-item"><div class="pg-item-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg></div><div class="pg-item-content"><div class="pg-item-title">Referral from Dr. Emily Park</div><div class="pg-item-sub">PTSD treatment — Patient: Maria S.</div></div><span class="badge badge-green">Active</span><span class="pg-item-meta">5 days ago</span></div>
      <div class="pg-item"><div class="pg-item-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg></div><div class="pg-item-content"><div class="pg-item-title">Referral to Dr. James Okafor</div><div class="pg-item-sub">Neuropsychological assessment — Patient: Robert K.</div></div><span class="badge badge-warning">Pending</span><span class="pg-item-meta">1 week ago</span></div>
    </div>
  </AppLayout>
</template>
