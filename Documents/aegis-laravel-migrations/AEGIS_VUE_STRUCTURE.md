...
**Inertia props:** `connections`, `shadowNetwork`, `filters`, `tier`
**Child components used:** `AegisHeroBanner`, `AegisCard`, `AegisBadge`, `AegisEmptyState`
**Modals:** `addConnectionModal`, `inviteProviderModal`, `connectionDetailModal`
**Write:** POST `/api/network` (save_network domain)
