<!--
  pages/support-steward/ImportantDocuments.vue — documents shared with SS.
-->
<template>
  <AppLayout>
    <AegisHeroBanner eyebrow="Activation" title="Important Documents" subtitle="Practice documents practitioners have shared with you." />
    ...
    <AegisCard v-if="documents.length">
      <table class="data-table">
        <thead><tr><th>Document</th><th>Practitioner</th><th>Updated</th><th></th></tr></thead>
        <tbody>
          <tr v-for="d in documents" :key="d.id">
            <td class="data-table-primary">
              <AegisIcon name="file-text" :size="13" /> {{ d.title }}
            </td>
