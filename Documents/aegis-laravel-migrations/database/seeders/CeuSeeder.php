    ...
    public function run(): void
    {
        ...
        $entries = [
            [
                ...
                'certificate_ref' => 'ceu/p_sarah/emdr_l2.pdf',
            ...
            [
                ...
                'certificate_ref' => 'ceu/p_sarah/telehealth_ethics.pdf',
            ...
            [
                ...
                'expires_on'      => $now->copy()->addYears(2)->toDateString(),
                'certificate_ref' => 'ceu/p_maria/gottman_l3.pdf',
            ...
            [
                ...
                'expires_on'      => $now->copy()->addYears(3)->toDateString(),
                'certificate_ref' => 'ceu/p_david/cbt_refresher.pdf',
