...
class ServiceSession extends Model
{
    ...
    protected $fillable = [
        ...
        'status', 'scheduled_at', 'timezone', 'completed_at', 'amount_cents',
    ...
    public function serviceRequest(): BelongsTo { return $this->belongsTo(ServiceRequest::class, 'service_request_id'); }
