...
<div class="doc-shell">
  <div class="doc-header">
    <div class="doc-logo">Aegis</div>
    <div class="doc-type-label">Continuity Steward Agreement</div>
  </div>
  <div class="doc-title-block">
    <div class="doc-title">CS Agreement &#8212; {$csName}</div>
    <div class="doc-subtitle">Continuity Plan &#183; {$providerName}</div>
  </div>
  ...
  <div class="party-grid">
    <div class="party-col"><div class="party-label">Provider</div><div class="party-name">{$providerName}</div></div>
    <div class="party-col"><div class="party-label">Continuity Steward</div><div class="party-name">{$csName}</div>{$creds}</div>
  </div>
