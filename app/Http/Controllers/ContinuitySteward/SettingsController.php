    ...
    public function cancelPlan(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $this->activity->log(
                ...
                'You cancelled your Business CS subscription. Access continues until end of billing period.',
                \App\Models\User::class, $user->id,
                null, 'log', $user->id,
            );
    ...
    public function resumePlan(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $this->activity->log(
                ...
                'You reactivated your Business CS subscription.',
                \App\Models\User::class, $user->id,
                null, 'log', $user->id,
            );
