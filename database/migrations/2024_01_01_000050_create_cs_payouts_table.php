<?php
// Domain 9 — cs_payouts — UC-ADM-044,045
...
return new class extends Migration
{
    ...
    {
        Schema::create('cs_payouts', function (Blueprint $table) {
            ...
            $table->index(['status', 'created_at'], 'ix_cspayout_status_created');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('cs_payouts');
    }
};
