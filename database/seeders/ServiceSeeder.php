...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $requests = [
            ...
            ['id'=>'sreq_linda_cons',  'service_id'=>'svc_sarah_consult', 'practitioner_id'=>'p_sarah', 'inquirer_id'=>'ss_linda',  'message'=>'Requesting consultation on a complex trauma case with dissociative features. Client has DID and I want a second perspective on treatment approach.', 'status'=>'new',      'response_note'=>null, 'responded_at'=>null,                                              'created_at'=>$now->copy()->subHours(5)->toDateTimeString(),  'updated_at'=>$now->copy()->subHours(5)->toDateTimeString()],
            ['id'=>'sreq_marcus_sup',  'service_id'=>'svc_sarah_sup_ind', 'practitioner_id'=>'p_sarah', 'inquirer_id'=>'cs_marcus', 'message'=>'Looking for individual supervision as I work toward my LCSW. 18 months post-grad, focus on trauma and crisis.', 'status'=>'new',      'response_note'=>null, 'responded_at'=>null,                                              'created_at'=>$now->copy()->subDays(1)->toDateTimeString(),   'updated_at'=>$now->copy()->subDays(1)->toDateTimeString()],
