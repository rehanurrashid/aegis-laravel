...
class BpSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $jobs = [
            ...
            // ── p_sarah legal review (pending_signature demo) ────────────
            [
                'id'                  => 'job_sarah_legal',
                'practitioner_id'     => 'p_sarah',
                'title'               => 'Contract & Policy Legal Review',
                'category'            => 'legal',
                'job_type'            => 'one_time',
                'location_pref'       => 'remote',
                'description'         => 'Attorney review of intake agreements, informed consent, telehealth policies, and BAA templates for TX + CA practice states. Written summary + redlines expected.',
                'experience_level'    => 'expert',
                'requires_hipaa'      => 1,
                'budget_type'         => 'fixed',
                'budget_amount_cents' => 220000,
                'status'              => 'filled',
                'is_urgent'           => 0,
                'proposals_count'     => 1,
                'posted_at'           => $now->copy()->subDays(4),
                'closes_at'           => null,
                'created_at'          => $now->copy()->subDays(4),
                'updated_at'          => $now->copy()->subDays(1),
            ],
            // ── p_sarah design refresh (pending_funding demo) ────────────
            [
                'id'                  => 'job_sarah_design',
                'practitioner_id'     => 'p_sarah',
                'title'               => 'Practice Website & Brand Refresh',
                'category'            => 'design',
                'job_type'            => 'one_time',
                'location_pref'       => 'remote',
                'description'         => 'Landing page redesign, updated brand palette, and printable client welcome packet. 4-week sprint with 2 review rounds.',
                'experience_level'    => 'mid',
                'requires_hipaa'      => 0,
                'budget_type'         => 'fixed',
                'budget_amount_cents' => 180000,
        ...
        $proposals = [
            ...
            // ── job_sarah_legal — ACCEPTED (leads to pending_signature contract) ──
            [
                'id'                  => 'prop_acme_sarah_legal',
                'job_id'              => 'job_sarah_legal',
                'bp_id'               => 'bp_acme',
                'cover_letter'        => 'Our team includes a licensed healthcare attorney in both TX and CA. We turn around review + redlines in 10 business days with a 30-min call included.',
                'proposed_rate_cents' => 220000,
                'proposed_rate_type'  => 'fixed',
                'status'              => 'accepted',
                'pipeline_stage'      => 'hired',
                'submitted_at'        => $now->copy()->subDays(4),
            ...
            // ── job_sarah_design — ACCEPTED (leads to pending_funding contract) ──
            [
                'id'                  => 'prop_nexus_sarah_design',
                'job_id'              => 'job_sarah_design',
                'bp_id'               => 'bp_team_owner',
                'cover_letter'        => 'Nexus Design will pair a senior brand designer with a healthcare-focused UX lead. Deliverables include a Figma prototype, printable PDFs, and a Webflow handoff.',
                'proposed_rate_cents' => 180000,
                'proposed_rate_type'  => 'fixed',
                'status'              => 'accepted',
                'pipeline_stage'      => 'hired',
        ...
        $contracts = [
            ...
            // 6. PENDING_SIGNATURE — Acme × p_sarah (legal review, awaiting both signatures)
            // Demos the "Awaiting Signature" chip in Hired tab + BpFinanceTable Action-Required.
            [
                'id'                => 'contract_acme_sarah_legal',
                'job_id'            => 'job_sarah_legal',
                'proposal_id'       => 'prop_acme_sarah_legal',
                'practitioner_id'   => 'p_sarah',
                'bp_id'             => 'bp_acme',
                'title'             => 'Contract & Policy Legal Review',
                ...
                'total_value_cents' => 220000,
                'escrow_funded_cents'   => 0,
                'escrow_released_cents' => 0,
                'escrow_refunded_cents' => 0,
                'transfer_group'    => 'aegis_contract_acme_sarah_legal',
                'practitioner_signed_at'      => null,
                'practitioner_signature_name' => null,
                'bp_signed_at'                => null,
                'bp_signature_name'           => null,
            ...
            // 7. PENDING_FUNDING — Nexus × p_sarah (design refresh, fully executed, needs funding)
            // Demos the "Awaiting Funding" chip and escrow unfunded summary.
            [
                'id'                => 'contract_nexus_sarah_design',
                'job_id'            => 'job_sarah_design',
                'proposal_id'       => 'prop_nexus_sarah_design',
                'practitioner_id'   => 'p_sarah',
                'bp_id'             => 'bp_team_owner',
                'title'             => 'Practice Website & Brand Refresh',
                ...
                'escrow_released_cents' => 0,
                'escrow_refunded_cents' => 0,
                'transfer_group'    => 'aegis_contract_nexus_sarah_design',
                'practitioner_signed_at'      => $now->copy()->subDays(4),
                'practitioner_signature_name' => 'Sarah Johnson',
                'bp_signed_at'                => $now->copy()->subDays(3),
                'bp_signature_name'           => 'Nexus Consulting',
                'fully_executed_at'           => $now->copy()->subDays(3),
