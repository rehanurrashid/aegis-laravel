...
class BpSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $jobs = [
            ...
            // ── p_sarah ops consulting (active escrow demo) ──────────────
            [
                'id'                  => 'job_sarah_ops',
                'practitioner_id'     => 'p_sarah',
                'title'               => 'Practice Operations Support — Workflow Automation',
                'category'            => 'consulting',
                'job_type'            => 'one_time',
                'location_pref'       => 'remote',
                'description'         => 'Looking for an operations specialist to document and automate our client intake, scheduling, and insurance verification workflows. Deliverables: 3 SOPs + EHR automation setup.',
                'experience_level'    => 'mid',
                'requires_hipaa'      => 1,
                'budget_type'         => 'fixed',
                'budget_amount_cents' => 360000,
                'status'              => 'filled',
                'is_urgent'           => 0,
                'proposals_count'     => 1,
                'posted_at'           => $now->copy()->subDays(18),
                'closes_at'           => null,
        ...
        $proposals = [
            ...
            // ── job_sarah_ops — ACCEPTED ──────────────────────────────────
            [
                'id'                  => 'prop_jamal_sarah_ops',
                'job_id'              => 'job_sarah_ops',
                'bp_id'               => 'bp_jamal',
                'cover_letter'        => 'I\'ve helped 5 solo mental health practices document and streamline their intake and scheduling SOPs. I use Notion + Zapier for workflow automation alongside SimplePractice and Jane App. I can deliver all 3 SOPs within 3 weeks and handle the EHR automation setup in the 4th week.',
                'proposed_rate_cents' => 350000,
                'proposed_rate_type'  => 'fixed',
                'status'              => 'accepted',
                'pipeline_stage'      => 'hired',
                'submitted_at'        => $now->copy()->subDays(15),
                'responded_at'        => $now->copy()->subDays(12),
            ],
        ...
        $contracts = [
            ...
            // 6. ACTIVE — Jamal × p_sarah (ops consulting, full escrow demo)
            [
                'id'               => 'contract_jamal_sarah_ops',
                'job_id'           => 'job_sarah_ops',
                'proposal_id'      => 'prop_jamal_sarah_ops',
                'practitioner_id'  => 'p_sarah',
                'bp_id'            => 'bp_jamal',
                'title'            => 'Practice Operations SOP & Workflow Automation',
                'status'           => 'active',
                'payment_type'     => 'milestone',
                'funding_mode'     => 'per_milestone',
                'total_value_cents'=> 360000,
                'escrow_funded_cents'   => 240000,
                'escrow_released_cents' => 120000,
                'escrow_refunded_cents' => 0,
                'transfer_group'   => 'aegis_contract_jamal_sarah_ops',
                'practitioner_signed_at'      => $now->copy()->subDays(11),
                'practitioner_signature_name' => 'Sarah Johnson',
                'bp_signed_at'                => $now->copy()->subDays(10),
                'bp_signature_name'           => 'Jamal Wilson',
                'fully_executed_at'           => $now->copy()->subDays(10),
        ...
        $contractMeta = [
            ...
            ['contract_id' => 'contract_jamal_sarah_ops',         'meta_key' => 'scope_summary', 'meta_value' => '3 practice SOPs (intake, insurance verification, billing) + Zapier/SimplePractice automation setup. Per-milestone escrow payments released on SOP approval.'],
        ...
        $milestones = [
            ...
            // contract_jamal_sarah_ops — ms1 released, ms2 submitted, ms3 pending_funding
            [
                'id'               => 'ms_jamal_sarah_ops_1',
                'contract_id'      => 'contract_jamal_sarah_ops',
                'title'            => 'SOP #1 — Client Intake & Scheduling Workflow',
                'description'      => 'Document current intake process, identify bottlenecks, deliver written SOP with EHR step-by-step guide.',
                'amount_cents'     => 120000,
                'status'           => 'released',
                'funded_cents'     => 120000,
                'released_cents'   => 120000,
                'escrow_intent_id' => 'pi_demo_ops_ms1',
                'escrow_charge_id' => 'ch_demo_ops_ms1',
                'transfer_id'      => 'tr_demo_ops_ms1',
                'funded_at'        => $now->copy()->subDays(9),
                'released_at'      => $now->copy()->subDays(4),
                'due_at'           => $now->copy()->subDays(5),
                'submitted_at'     => $now->copy()->subDays(6),
                'approved_at'      => $now->copy()->subDays(4),
                'paid_at'          => $now->copy()->subDays(4),
                'auto_release_at'  => $now->copy()->subDays(6)->addDays(7),
                'revision_count'   => 0,
                'sort_order'       => 1,
            ],
            [
                'id'               => 'ms_jamal_sarah_ops_2',
                'contract_id'      => 'contract_jamal_sarah_ops',
                'title'            => 'SOP #2 — Insurance Verification & Authorization',
                'description'      => 'Map and document insurance verification steps, prior auth checklist, denial prevention protocols.',
                'amount_cents'     => 120000,
                'status'           => 'submitted',
                'funded_cents'     => 120000,
                'released_cents'   => 0,
                'escrow_intent_id' => 'pi_demo_ops_ms2',
                'escrow_charge_id' => 'ch_demo_ops_ms2',
                'transfer_id'      => null,
                'funded_at'        => $now->copy()->subDays(4),
                'released_at'      => null,
                'due_at'           => $now->copy()->addDays(2),
                'submitted_at'     => $now->copy()->subDays(1),
                'approved_at'      => null,
                'paid_at'          => null,
                'auto_release_at'  => $now->copy()->subDays(1)->addDays(7),
                'revision_count'   => 0,
                'sort_order'       => 2,
            ],
            [
                'id'               => 'ms_jamal_sarah_ops_3',
                'contract_id'      => 'contract_jamal_sarah_ops',
                'title'            => 'EHR Automation Setup (Zapier + SimplePractice)',
                'description'      => 'Configure Zapier automations for intake forms, appointment reminders, and post-session follow-ups within SimplePractice.',
                'amount_cents'     => 120000,
                'status'           => 'pending_funding',
                'funded_cents'     => 0,
                'released_cents'   => 0,
                'escrow_intent_id' => null,
                'escrow_charge_id' => null,
                'transfer_id'      => null,
                'funded_at'        => null,
                'released_at'      => null,
        ...
        $bpPayouts = [
            // jamal_sarah_ops ms1 — released
            ['id'=>'bpo_jamal_sarah_ops_ms1', 'bp_id'=>'bp_jamal', 'contract_id'=>'contract_jamal_sarah_ops', 'milestone_id'=>'ms_jamal_sarah_ops_1', 'amount'=>120000, 'desc'=>'Milestone: SOP #1 — Client Intake & Scheduling Workflow', 'paid_at'=>$now->copy()->subDays(4)],
