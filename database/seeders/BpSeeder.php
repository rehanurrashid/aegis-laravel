...
class BpSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── BP Contracts ───────────────────────────────────────────────────
        $contracts = [
            // 1. Active — Acme × p_maria (ongoing billing)
            [
            ...
            // 2. COMPLETED — Acme × p_sarah (billing clean-up project, done)
            [
            ...
            // 3. COMPLETED — Nexus × p_david (placeholder past engagement)
            [
                'id'               => 'contract_nexus_david',
                'job_id'           => 'job_david_billing',
                'proposal_id'      => null,   // legacy — pre-dates unique constraint
                'practitioner_id'  => 'p_david',
                'bp_id'            => 'bp_team_owner',
        ...
        // ── BP Milestones ──────────────────────────────────────────────────
        $milestones = [
            // contract_acme_maria — active contract milestones
            [
                'id'           => 'ms_acme_maria_1',
            ...
            [
                ...
                'description'  => 'Deliver Q1 revenue cycle performance report.',
                'amount_cents' => 145000,
                'status'       => 'pending',
            ...
            // contract_acme_sarah_billing — completed contract milestones
            [
                'id'           => 'ms_acme_sarah_1',
            ...
            // contract_nexus_david — completed contract milestones
            [
                'id'           => 'ms_nexus_david_1',
        ...
        foreach ($milestones as $m) {
            $m = array_merge([
                ...
                'created_at'         => $m['due_at'],
                'updated_at'         => $m['approved_at'] ?? $m['submitted_at'] ?? $m['due_at'],
                'deleted_at'         => null,
            ], $m);
